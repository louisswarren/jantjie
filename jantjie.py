...
def setup(conn):
    ...
    ''')
    c.execute("INSERT INTO posts (comment) VALUES ('Hello')")
    c.execute("INSERT INTO posts (comment) VALUES ('How are you?')")
    c.execute("INSERT INTO posts (comment) VALUES ('Goodbye')")
    conn.commit()
